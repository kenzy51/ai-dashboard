...
export default function Home() {
  ...
  return (
    <div className="p-8 space-y-10 animate-in fade-in duration-700">
      ...
      <div className="relative overflow-hidden bg-zinc-900/40 backdrop-blur-xl border border-white/10 rounded-[40px] p-10 shadow-2xl">
        <div className="relative z-10 space-y-4">
          ...
          <p className="text-zinc-400 text-lg max-w-xl">
            Sarah is currently online and managing freight inquiries for TRT International.
          </p>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="p-6 bg-zinc-900/20 border border-white/5 rounded-[32px] flex items-center gap-4 col-span-2">
            ...
            <div>
              <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-widest">Active Line</p>
              <h4 className="text-2xl font-mono text-white tracking-tighter">+1 (929) 702-2797</h4>
            </div>
          </div>
          ...
          <div className="p-6 bg-zinc-900/20 border border-white/5 rounded-[32px] flex flex-col justify-center">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-widest">Total Logs</p>
            </div>
          ...
          <div className="p-6 bg-zinc-900/20 border border-white/5 rounded-[32px] flex flex-col justify-center">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-widest">AI Accuracy</p>
            </div>
            <span className="text-4xl font-bold text-[#d4ff33] tracking-tighter">98.2%</span>
          </div>
        </div>
      </div>
      ...
      {/* 3. QUICK COMMANDS */}
      <div className="space-y-4">
        <h3 className="text-zinc-400 font-bold uppercase text-[10px] tracking-[0.2em] px-2">Navigation</h3>
